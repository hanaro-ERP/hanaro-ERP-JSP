...
<body>\
	...
	<main>
		...
		<div class="innerContainer">
			...
			<form action="${pageContext.request.contextPath}/loan/subscription"
				method="post" >
	<!-- 			onsubmit="return validateForm()" -->
				...
				<table class="inputTable">
					...
					<tr>
						...
						<td><input type="hidden" id="address" name="address"
							...
							<%= customer != null ? customer.getAddress() : "" %></td>
						<th>국가</th>
						<td><input type="hidden" id="country" name="country"
							value="<%= customer != null ? customer.getCountry() : "" %>">
							<%= customer != null ? customer.getCountry() : "" %></td>
					</tr>
					<tr>
						<th>주민번호</th>
						<td>
						...
						%> <%= id1 + "-" + id2%> <input type="hidden" id="identification"
							name="identification"
						...
						<td><input type="hidden" id="jobCode" name="jobCode"
							value="<%= customer != null ? customer.getJobName() : "" %>">
					...
					<tr>
						...
						<td><input type="hidden" id="employeeName"
							name="employeeName"
							value="<%= customer != null ? customer.getEmployeeName() : "" %>">
							<%= customer != null ? customer.getEmployeeName() : "" %></td>
						<th class="office">주거래지점</th>
						<td><input type="hidden" id="bankName" name="bankName"
				...
				<table class="inputTable">
					...
					<tr>
						<th>이자 / 대출기간</th>
						<td>&nbsp;연 <input type="number" step="0.1" max="10"
							id="interestRate" name="interestRate" class="shortInput" /> %
							&nbsp; | &nbsp;&nbsp; <input type="number" step="0.1" max="10"
							id="loanPeriod" name="loanPeriod" class="shortInput" /> 년
						</td>
						<th>거치 기간</th>
						<td><input name="gracePeriod" class="shortInput"
							id="gracePeriod"> 년
					</tr>
					<tr>
						<th>상환 방법</th>
				...
				<form action="${pageContext.request.contextPath}/loan/repayment"
					method="post">
					<input type="hidden" name="myList" id="myListInput"> 
