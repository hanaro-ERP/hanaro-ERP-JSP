...
<link rel="stylesheet" href="${pageContext.request.contextPath}/view/loan/loanContract/loanContract.css?ver=1">
...
<body><%@ include file="../../../components/header/header.jsp" %>
	<main>
		...
		<div class="innerContainer">
			...
			<form action="${pageContext.request.contextPath}/loanContract" method="post">
				...
				<div class="innerInformation">
					...
					<div class="innerInformationRow">
						...
						<ul class="loanIssueDate" id="loanContractStartDate">
							...
							<li id="directInput">
								...
								<select name="loanContractStartDate" class="daySelect" disabled="true"> </select>							</li>
							</li>
						</ul>
					</div>
					<div class="innerInformationRow">
						...
						<ul class="loanMuturityDate" id="loanContractEndDate">
							...
							<li id="directInput">
								...
								<select name="loanContractEndDate" class="daySelect" disabled="true"> </select>							</li>
							</li>
						</ul>
					</div>
					<div class="innerInformationRow" id="balance">
						...
						<ul id="balanceList">
							...
							<li><input type="checkbox" value="1억원 이상" id="price10000plus">1억원 이상</li>
						</ul>
					</div>
					<div class="innerInformationRow">
						...
						<ul id="loanContractLimit">
							...
							<li><input type="checkbox" value="5년 이상" id="period60plus">5년 이상</li>
						</ul>
					</div>
				</div>	
	...
	<script src="${pageContext.request.contextPath}/view/loan/loanContract/loanContract.js "></script>
</body>
</html>
