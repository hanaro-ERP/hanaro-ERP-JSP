		...
		<div class="mainContainer">
			...
			<div class="customerInformationContainer">
				...
				<table class="customerInformationTable">
					...
					<tr>
						<th id="surety">보증인</th>
						<td><input id="surety" /></td>
						<th>주민번호</th>
						<td>
							<input class="short" id="residentRegistrationNumber1"/>
								-
							<input class="short" id="residentRegistrationNumber2"/>
						</td>
					</tr>
					<tr>
						<th>나이</th>
						<td>
							<input type="text" class="short" id="ageMin"/>
								세 이상
						...
						<td>
							<select>
								<option value="male" class="short">남성</option>
								<option value="female" class="short">여성</option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<form name="form">
								<select name="city" onchange="changeCounty(this.selectedIndex);">
				...
				<table class="customerInfo">
					<tr>
						...
						<td>
							<select>
								<option value="prod1" class="short">상품1</option>
								<option value="prod2" class="short">상품2</option>
								<option value="prod3" class="short">상품3</option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<select>
								<option value="house" class="short">주택</option>
								<option value="car" class="short">자동차</option>
								<option value="car" class="short">주식</option>
							</select>
						</td>
						<th>담보가치</th>
						<td>
							<input type="text" class="short" id="collateralValue"/>만원
						</td>
					</tr>
					<tr>
						<th>대출 금액</th>
						<td>
							<input type="text" class="short" id="loanAmount"/>만원
						</td>
						<th>이자</th>
						<td>
							<select>
								<option value="simple" class="short">복리</option>
								<option value="compound" class="short">단리</option>
							</select>
							연
							<input type="text" class="short" id="interest"/>
							%
						</td>
					</tr>
					<tr>
